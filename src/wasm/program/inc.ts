        ...
        return makeInstr(
            (code: Code) => {
                code.push(
                    this.prg.set.i32(
                        local,
                        this.prg.add.i32(this.prg.get.i32(local), delta)
                    )
                )
                return VOID
            },
        ...
        return makeInstr(
            (code: Code) => {
                code.push(
                    this.prg.set.i64(
                        local,
                        this.prg.add.i64(this.prg.get.i64(local), delta)
                    )
                )
                return VOID
            },
        ...
        return makeInstr(
            (code: Code) => {
                code.push(
                    this.prg.set.f32(
                        local,
                        this.prg.add.f32(this.prg.get.f32(local), delta)
                    )
                )
                return VOID
            },
        ...
        return makeInstr(
            (code: Code) => {
                code.push(
                    this.prg.set.f64(
                        local,
                        this.prg.add.f64(this.prg.get.f64(local), delta)
                    )
                )
                return VOID
            },
