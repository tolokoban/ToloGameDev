...
export default function Help() {
    return (
        <div className="view-page-painter-section-shader-Help">
            ...
            <div className="uniforms-grid">
                ...
                <div>
                    <code>uniPointer.x</code>: X coord of the pointer between -1
                    and +1.
                    <br />
                    <code>uniPointer.y</code>: Y coord of the pointer between -1
                    and +1.
                    <br />
                    <code>uniPointer.z</code>: Pointer pressure between 0 and +1
                    (0 if no touch).
                    <br />
                </div>
