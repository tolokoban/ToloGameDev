...
then
  ...
  byobu-tmux send-keys -t 0 "cd $DIR/lib/dist" 'C-m'
  byobu-tmux send-keys -t 0 'npm link' 'C-m'
  byobu-tmux send-keys -t 0 'cd ..' 'C-m'
  ...
  byobu-tmux send-keys -t 1 'npm link tolo-game-dev' 'C-m'
  byobu-tmux send-keys -t 1 'npm start' 'C-m'

  byobu-tmux new-window
  byobu-tmux rename-window '(lab)'
  byobu-tmux send-keys -t 0 "cd $DIR/lab" 'C-m'
  byobu-tmux split-window -h
  byobu-tmux send-keys -t 1 "cd $DIR/lab" 'C-m'
  byobu-tmux send-keys -t 1 'npm link tolo-game-dev' 'C-m'
  byobu-tmux send-keys -t 1 'npm start' 'C-m'
fi
# Enter byobu-tmux
